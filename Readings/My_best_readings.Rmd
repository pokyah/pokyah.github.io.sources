...
step2 <- function(consumer_key, code) {
  ...
  body <- list(consumer_key = consumer_key, access_token = access_token, state = "all", detailType = "complete")
...
auth <- step1(consumer_key = "78018-7092870695e638667bd814c6", callback_url = "localhost:8787")
data <- step2(code = auth$code, consumer_key = "78018-7092870695e638667bd814c6" )
table <- response_to_bookmarks(data)
```
